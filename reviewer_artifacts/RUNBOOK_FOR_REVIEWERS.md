...
## 28 Years Elapsed [29 Years Inclusive] of Intrusion Detection: 28 Years Elapsed [29 Years Inclusive] of Intrusion Detection: A Reproducible Evaluation of 30 Benchmarks from DARPA 1998 to ASEADOS-SDN-IoT 2026 with Conformal Guarantees

This document is the official evaluation guide prepared for the **Artifact Evaluation Committee (AEC)**. It provides step-by-step instructions to independently execute, audit, and reproduce all empirical results, mathematical guarantees, figures, and benchmark telemetry tables presented in 28-Year Intrusion Detection Benchmark Study.
...
[PASS] Step 3: Formal Invariant Test Suite (46 Tests) (46 passed in ~3s, 100% green)
...
Run pytest on the 30-Benchmark evaluation test suite:
```bash
